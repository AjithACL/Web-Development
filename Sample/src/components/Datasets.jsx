...
export default function Page2() {
  ...
  const [selected, setSelected] = React.useState(null); // Set to null for single selection
  ...
  const handleSelectRow = (event, id) => {
    setSelected(id); // Select a single row
  };
          ...
          >
            ...
            <TableBody>
              {visibleRows.map((row, index) => {
                const isItemSelected = selected === row.id; // Check if the row is selected
